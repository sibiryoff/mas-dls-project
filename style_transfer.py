...
class StyleTransfer():
    ...
    def run(self, file_path_1, file_path_2):
        content_img = image_loader(file_path_1)
        style_img = image_loader(file_path_2)
        input_img = content_img.clone()

        result = self.run_style_transfer(cnn, cnn_normalization_mean, cnn_normalization_std,
                                         content_img, style_img, input_img)
        return image_unloader(result)
